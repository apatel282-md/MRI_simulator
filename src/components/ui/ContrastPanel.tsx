    ...
    <section className="rounded-2xl border border-white/80 bg-white/80 p-4 shadow">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-full border border-white/70 bg-white/70 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-ink/60 transition hover:bg-white"
      ...
      {isOpen && (
        <>
          ...
          <div className="mt-3 text-[11px] text-ink/60">
            Reference: T1 (TR 500, TE 15), T2 (TR 3000, TE 80), PD (TR 3000, TE
            15)
          </div>
          <div className="mt-2 text-[11px] text-ink/60">
            Short TR emphasizes T1 recovery (fat bright). Long TE emphasizes T2
            decay (fluid bright).
          </div>
